...
I've shipped two production apps on this stack now: a [discounted-USPS-label marketplace](/projects/shipping-labels) and a [Spotify-shaped music streaming app](/projects/tonetouchmusic). Both run as a single Cloudflare Worker. Same bundle, same deploy, same dashboard. After the second one I figured the pattern was real enough to write down.
